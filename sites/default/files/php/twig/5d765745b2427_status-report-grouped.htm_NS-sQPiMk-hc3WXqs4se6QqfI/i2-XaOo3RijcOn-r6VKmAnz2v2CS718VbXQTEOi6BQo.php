...
$context["group"], "type", array()), array(0 => "warning", 1 => "error"))) ? (("system-status-report__status-icon system-status-report__status-icon--" . $this->getAttribute($context["group"], "type", array()))) : ("")));
                // line 34
                echo "          <summary";
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->createAttribute(array("class" => (isset($context["summary_classes"]) ? $context["summary_classes"] : null))), "html", null, true));
                echo " role=\"button\">
            ";
                // line 35
...
";
    ...
    {
        return new Twig_Source("", "core/themes/seven/templates/status-report-grouped.html.twig", "/opt/lampp/htdocs/drupal/core/themes/seven/templates/status-report-grouped.html.twig");
    }
}
