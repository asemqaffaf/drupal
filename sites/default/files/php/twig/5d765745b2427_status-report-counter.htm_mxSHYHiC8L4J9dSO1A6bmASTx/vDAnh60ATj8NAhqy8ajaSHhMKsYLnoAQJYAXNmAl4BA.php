...
(isset($context["severity"]) ? $context["severity"] : null)));
  ...
  <span class=\"system-status-counter__status-icon system-status-counter__status-icon--";
        // line 21
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["severity"]) ? $context["severity"] : null), "html", null, true));
        echo "\"></span>
  <span class=\"system-status-counter__status-title\">
    <span class=\"system-status-counter__title-count\">";
        // line 23
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["amount"]) ? $context["amount"] : null), "html", null, true));
        echo " ";
...
";
    ...
    {
        return new Twig_Source("", "core/themes/seven/templates/status-report-counter.html.twig", "/opt/lampp/htdocs/drupal/core/themes/seven/templates/status-report-counter.html.twig");
    }
}
